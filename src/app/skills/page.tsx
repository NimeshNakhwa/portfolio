  ...
  return (
    <div className="relative min-h-screen overflow-hidden text-center px-4 py-16 md:px-12">
      ...
      <div className="flex justify-center items-center gap-6 pt-6">
        <button
          onClick={prev}
          className="p-3 bg-gray-200 dark:bg-neutral-800 rounded-full hover:scale-105 transition"
        >
          <IconArrowLeft className="text-black dark:text-white" />
        </button>
        <button
          onClick={next}
          className="p-3 bg-gray-200 dark:bg-neutral-800 rounded-full hover:scale-105 transition"
        >
          <IconArrowRight className="text-black dark:text-white" />
        </button>
      </div>
    </div>
  );
